...
* [patchmatrix-0.22.0.zip](https://dl.open-music-kontrollers.ch/patchmatrix/stable/patchmatrix-0.22.0.zip) ([sig](https://dl.open-music-kontrollers.ch/patchmatrix/stable/patchmatrix-0.22.0.zip.sig))
...
* [patchmatrix-0.22.0.tar.xz](https://git.open-music-kontrollers.ch/lad/patchmatrix/snapshot/patchmatrix-0.22.0.tar.xz) ([sig](https://git.open-music-kontrollers.ch/lad/patchmatrix/snapshot/patchmatrix-0.22.0.tar.xz.asc))
